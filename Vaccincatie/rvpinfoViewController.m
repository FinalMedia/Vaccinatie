...
#import "rvpinfoViewController.h"
#import "GeneralSettings.h"
#import "SWRevealViewController.h"

@interface rvpinfoViewController ()

@end

@implementation rvpinfoViewController
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:@"rvpinfo" forKey:@"page"];
